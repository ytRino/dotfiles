...
# adb
alias adbp='adb-peco'
alias in='adbp shell input'
alias int='adbp shell input text'
alias ink='adbp shell input keyevent'
alias inke='adbp shell input keyevent 66' # Enter
alias inkes='adbp shell input keyevent 212' # Eisu
alias adata='adbp shell am start -d'
